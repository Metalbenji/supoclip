...
- **API Documentation**: `http://${APP_HOST}:${BACKEND_HOST_PORT}/docs` (default `http://localhost:8181/docs`)
...
| `BACKEND_HOST_PORT` | `8181` | Host port bound to backend container port `8181` |
...
2. **Backend** (FastAPI + Python) - Port 8181
...
- Check out the API docs at `http://${APP_HOST}:${BACKEND_HOST_PORT}/docs` (default `http://localhost:8181/docs`)
...
- View API documentation: `http://${APP_HOST}:${BACKEND_HOST_PORT}/docs` (default `http://localhost:8181/docs`)
