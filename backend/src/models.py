...
class Task(Base):
    ...
    clip_context: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    content_tone: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
...
class GeneratedClip(Base):
    ...
    generated_hashtags: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
